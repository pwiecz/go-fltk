...
func (w *GlWindow) MakeCurrent() {
	C.go_fltk_Gl_Window_make_current((*C.Fl_Gl_Window)(w.ptr()))
}
...
func (w *GlWindow) ContextValid() bool {
	return C.go_fltk_Gl_Window_context_valid((*C.Fl_Gl_Window)(w.ptr())) != 0
}
func (w *GlWindow) Valid() bool {
	return C.go_fltk_Gl_Window_valid((*C.Fl_Gl_Window)(w.ptr())) != 0
}
func (w *GlWindow) CanDo() bool {
	return C.go_fltk_Gl_Window_can_do((*C.Fl_Gl_Window)(w.ptr())) != 0
}
func (w *GlWindow) SetMode(mode int) {
	C.go_fltk_Gl_Window_set_mode((*C.Fl_Gl_Window)(w.ptr()), C.int(mode))
}
