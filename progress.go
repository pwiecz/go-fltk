...
func (p *Progress) Maximum() float64 {
	return float64(C.go_fltk_Progress_maximum((*C.GProgress)(p.ptr)))
}
...
func (p *Progress) Minimum() float64 {
	return float64(C.go_fltk_Progress_minimum((*C.GProgress)(p.ptr)))
}
...
func (p *Progress) Value() float64 {
	return float64(C.go_fltk_Progress_value((*C.GProgress)(p.ptr)))
}
