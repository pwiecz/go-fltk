...
//const unsigned char go_FL_INT_INPUT = FL_INT_INPUT;
//const unsigned char go_FL_FLOAT_INPUT = FL_FLOAT_INPUT;

const int go_FL_NO_BOX = (int)FL_NO_BOX;
const int go_FL_FLAT_BOX = (int)FL_FLAT_BOX;
const int go_FL_UP_BOX = (int)FL_UP_BOX;
const int go_FL_DOWN_BOX = (int)FL_DOWN_BOX;
const int go_FL_UP_FRAME = (int)FL_UP_FRAME;
const int go_FL_DOWN_FRAME = (int)FL_DOWN_FRAME;
const int go_FL_THIN_UP_BOX = (int)FL_THIN_UP_BOX;
const int go_FL_THIN_DOWN_BOX = (int)FL_THIN_DOWN_BOX;
const int go_FL_ENGRAVED_BOX = (int)FL_ENGRAVED_BOX;
const int go_FL_EMBOSSED_BOX = (int)FL_EMBOSSED_BOX;
const int go_FL_ENGRAVED_FRAME = (int)FL_ENGRAVED_FRAME;
const int go_FL_EMBOSSED_FRAME = (int)FL_EMBOSSED_FRAME;
const int go_FL_BORDER_BOX = (int)FL_BORDER_BOX;
const int go_FL_BORDER_FRAME = (int)FL_BORDER_FRAME;
const int go_FL_SHADOW_FRAME = (int)_FL_SHADOW_FRAME;
const int go_FL_ROUNDED_BOX = (int)_FL_ROUNDED_BOX;
const int go_FL_RSHADOW_BOX = (int)_FL_RSHADOW_BOX;
const int go_FL_ROUNDED_FRAME = (int)_FL_ROUNDED_FRAME;
const int go_FL_RFLAT_BOX = (int)_FL_RFLAT_BOX;
const int go_FL_ROUND_UP_BOX = (int)_FL_ROUND_UP_BOX;
const int go_FL_ROUND_DOWN_BOX = (int)_FL_ROUND_DOWN_BOX;
const int go_FL_DIAMOND_UP_BOX = (int)_FL_DIAMOND_UP_BOX;
const int go_FL_DIAMOND_DOWN_BOX = (int)_FL_DIAMOND_DOWN_BOX;
const int go_FL_OVAL_BOX = (int)_FL_OVAL_BOX;
const int go_FL_OSHADOW_BOX = (int)_FL_OSHADOW_BOX;
const int go_FL_OVAL_FRAME = (int)_FL_OVAL_FRAME;
const int go_FL_OFLAT_BOX = (int)_FL_OFLAT_BOX;
const int go_FL_PLASTIC_UP_BOX = (int)_FL_PLASTIC_UP_BOX;
const int go_FL_PLASTIC_DOWN_BOX = (int)_FL_PLASTIC_DOWN_BOX;
const int go_FL_PLASTIC_UP_FRAME = (int)_FL_PLASTIC_UP_FRAME;
const int go_FL_PLASTIC_DOWN_FRAME = (int)_FL_PLASTIC_DOWN_FRAME;
const int go_FL_PLASTIC_THIN_UP_BOX = (int)_FL_PLASTIC_THIN_UP_BOX;
const int go_FL_PLASTIC_THIN_DOWN_BOX = (int)_FL_PLASTIC_THIN_DOWN_BOX;
const int go_FL_PLASTIC_ROUND_UP_BOX = (int)_FL_PLASTIC_ROUND_UP_BOX;
const int go_FL_PLASTIC_ROUND_DOWN_BOX = (int)_FL_PLASTIC_ROUND_DOWN_BOX;
const int go_FL_GTK_UP_BOX = (int)_FL_GTK_UP_BOX;
const int go_FL_GTK_DOWN_BOX = (int)_FL_GTK_DOWN_BOX;
const int go_FL_GTK_UP_FRAME = (int)_FL_GTK_UP_FRAME;
const int go_FL_GTK_DOWN_FRAME = (int)_FL_GTK_DOWN_FRAME;
const int go_FL_GTK_THIN_UP_BOX = (int)_FL_GTK_THIN_UP_BOX;
const int go_FL_GTK_THIN_DOWN_BOX = (int)_FL_GTK_THIN_DOWN_BOX;
const int go_FL_GTK_THIN_UP_FRAME = (int)_FL_GTK_THIN_UP_FRAME;
const int go_FL_GTK_THIN_DOWN_FRAME = (int)_FL_GTK_THIN_DOWN_FRAME;
const int go_FL_GTK_ROUND_UP_BOX = (int)_FL_GTK_ROUND_UP_BOX;
const int go_FL_GTK_ROUND_DOWN_BOX = (int)_FL_GTK_ROUND_DOWN_BOX;
const int go_FL_GLEAM_UP_BOX = (int)_FL_GLEAM_UP_BOX;
const int go_FL_GLEAM_DOWN_BOX = (int)_FL_GLEAM_DOWN_BOX;
const int go_FL_GLEAM_UP_FRAME = (int)_FL_GLEAM_UP_FRAME;
const int go_FL_GLEAM_DOWN_FRAME = (int)_FL_GLEAM_DOWN_FRAME;
const int go_FL_GLEAM_THIN_UP_BOX = (int)_FL_GLEAM_THIN_UP_BOX;
const int go_FL_GLEAM_THIN_DOWN_BOX = (int)_FL_GLEAM_THIN_DOWN_BOX;
const int go_FL_GLEAM_ROUND_UP_BOX = (int)_FL_GLEAM_ROUND_UP_BOX;
const int go_FL_GLEAM_ROUND_DOWN_BOX = (int)_FL_GLEAM_ROUND_DOWN_BOX;
