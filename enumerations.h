...
extern "C" {
  ...
  extern const int go_FL_SHADOW_FRAME;
  extern const int go_FL_ROUNDED_BOX;
  extern const int go_FL_RSHADOW_BOX;
  extern const int go_FL_ROUNDED_FRAME;
  extern const int go_FL_RFLAT_BOX;
  extern const int go_FL_ROUND_UP_BOX;
  extern const int go_FL_ROUND_DOWN_BOX;
  extern const int go_FL_DIAMOND_UP_BOX;
  extern const int go_FL_DIAMOND_DOWN_BOX;
  extern const int go_FL_OVAL_BOX;
  extern const int go_FL_OSHADOW_BOX;
  extern const int go_FL_OVAL_FRAME;
  extern const int go_FL_OFLAT_BOX;
  extern const int go_FL_PLASTIC_UP_BOX;
  extern const int go_FL_PLASTIC_DOWN_BOX;
  extern const int go_FL_PLASTIC_UP_FRAME;
  extern const int go_FL_PLASTIC_DOWN_FRAME;
  extern const int go_FL_PLASTIC_THIN_UP_BOX;
  extern const int go_FL_PLASTIC_THIN_DOWN_BOX;
  extern const int go_FL_PLASTIC_ROUND_UP_BOX;
  extern const int go_FL_PLASTIC_ROUND_DOWN_BOX;
  extern const int go_FL_GTK_UP_BOX;
  extern const int go_FL_GTK_DOWN_BOX;
  extern const int go_FL_GTK_UP_FRAME;
  extern const int go_FL_GTK_DOWN_FRAME;
  extern const int go_FL_GTK_THIN_UP_BOX;
  extern const int go_FL_GTK_THIN_DOWN_BOX;
  extern const int go_FL_GTK_THIN_UP_FRAME;
  extern const int go_FL_GTK_THIN_DOWN_FRAME;
  extern const int go_FL_GTK_ROUND_UP_BOX;
  extern const int go_FL_GTK_ROUND_DOWN_BOX;
  extern const int go_FL_GLEAM_UP_BOX;
  extern const int go_FL_GLEAM_DOWN_BOX;
  extern const int go_FL_GLEAM_UP_FRAME;
  extern const int go_FL_GLEAM_DOWN_FRAME;
  extern const int go_FL_GLEAM_THIN_UP_BOX;
  extern const int go_FL_GLEAM_THIN_DOWN_BOX;
  extern const int go_FL_GLEAM_ROUND_UP_BOX;
  extern const int go_FL_GLEAM_ROUND_DOWN_BOX;
