...
#cgo arm,linux LDFLAGS: ${SRCDIR}/lib/linux/arm/libfltk.a ${SRCDIR}/lib/linux/arm/libfltk_images.a ${SRCDIR}/lib/linux/arm/libfltk_z.a ${SRCDIR}/lib/linux/arm/libfltk_jpeg.a ${SRCDIR}/lib/linux/arm/libfltk_png.a ${SRCDIR}/lib/linux/arm/libfltk_gl.a -lGLU -lGL -lXrender -lXcursor -lXfixes -lXext -lXft -lfontconfig -lXinerama -lpthread -ldl -lm -lX11 -lcairo -lpango-1.0 -lpangoxft-1.0 -lgobject-2.0 -lpangocairo-1.0#cgo amd64,windows LDFLAGS: -L${SRCDIR}/lib/windows/x64 -lfltk -lfltk_images -lfltk_z -lfltk_png -lfltk_jpeg -lfltk_gl -lglu32 -lopengl32 -lgdiplus -lgdi32 -luser32 -lole32 -lcomctl32 -luuid -lws2_32 -lcomdlg32
