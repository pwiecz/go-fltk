...
#cgo arm,linux LDFLAGS: ${SRCDIR}/lib/linux/arm/libfltk.a ${SRCDIR}/lib/linux/arm/libfltk_images.a ${SRCDIR}/lib/linux/arm/libfltk_z.a ${SRCDIR}/lib/linux/arm/libfltk_jpeg.a ${SRCDIR}/lib/linux/arm/libfltk_png.a ${SRCDIR}/lib/linux/arm/libfltk_gl.a -lXrender -lXcursor -lXfixes -lXft -lfontconfig -lXinerama -pthread -lpthread -ldl -lm -lX11
